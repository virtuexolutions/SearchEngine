  ...
  const [modalVisible, setModalVisible] =  useState(false);
    ...
    style={{
      ...
      backgroundColor: 'white',
        ...
        <Header
        showBack={true}
        title={'Edit Profile'} headerColor={['white', 'white']} 
        />
    <View style={styles.info}>
        <View style={styles.imageContainer}>
            <CustomImage source={require('../Assets/Images/dummyUser1.png')} style={styles.image}/>
        ...
        <TouchableOpacity style={styles.camera} onPress={() =>{
            ...
            <Icon as={FontAwesome} name='camera' size={moderateScale(14,0.3)} 
            onPress={() =>{
                // setModalVisible(true);
            }}
            style={styles.icon}/>
...
const styles = StyleSheet.create({
    ...
    camera:{
        ...
        borderColor: '#72AFED' ,
        position:'absolute',
        left:moderateScale(113,0.4),
        bottom:moderateScale(12,0.4)
    },
    icon:{
        color:'blue'
    },
